    ...
    public partial class criacaoDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AluguelId = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AluguelId1 = table.Column<string>(nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "45fda70e-bc5b-4080-b83d-16d5bafbeee6", "2bd344aa-116b-4519-b26a-119616830f56", "Morador do Prédio", "Morador", "MORADOR" },
                    { "a9baa4a2-dfc5-4202-b276-763f4c986aaa", "d15264ba-af62-4545-8765-8c1d221cd435", "Sindico do Prédio", "Sindico", "SINDICO" },
                    { "8c41f956-2cf4-4bf4-84a8-728a5bd4b7cc", "895419e0-5ce8-460d-85eb-d98189906db8", "Administrador do Prédio", "Administrador", "ADMINISTRADOR" }
                });
